...
/**
 * Client-side wrapper for forgot password page with route protection
...
export const ForgotPasswordPageWrapper = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-brand-primary via-brand-primary/90 to-brand-secondary relative overflow-hidden">
      {/* Background Pattern */}
      <div

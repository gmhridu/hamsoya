...
export const API_CONFIG = {
  ...
  backend: {
    ...
    admin: {
      customers: {
        byId: (id: string) => `${BACKEND_API_URL}/admin/customers/${id}`,
        update: (id: string) => `${BACKEND_API_URL}/admin/customers/${id}`,
        delete: (id: string) => `${BACKEND_API_URL}/admin/customers/${id}`,
      },
    },

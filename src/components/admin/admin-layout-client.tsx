...
export function AdminLayoutClient({ children, initialUser }: AdminLayoutClientProps) {
  ...
  // If initialUser is null, middleware should have already redirected to login
  if (!initialUser) {
    console.log('AdminLayoutClient - No initial user but component rendered - this should not happen');
